...
This repo contains 8 sub-projects, each compilable as standalone
application. The repo also includes various support libraries of the
thi.ng collection as Git submodules, located in the [[./ext][/ext]] folder.
